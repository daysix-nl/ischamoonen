...
<section class="mt-[13.9949109414758vw] md:mt-[7.16145833333333vw] lg:mt-[5.078125vw]">
    <div class="element-fade-in w-[78.8804071246819vw] md:w-[68.40625vw] lg:w-[61.609375vw] mx-auto">
        <h1 class="text-[4.58015267175572vw] md:text-[2.60416666666667vw] lg:text-[2.34375vw] leading-[5.34351145038168vw] md:leading-[3.125vw] lg:leading-[2.734375vw] text-[#1E1E1E] font-normal text-center font-gilda"><?php echo get_field('header_title');?></h1>
    </div>
</section>
...
<!-- SERVICES -->
    ...
    <div class="element-fade-in w-[77.791349vw] md:w-[64.41875vw] lg:w-[58.03125vw] mx-auto">
        ...
        <h3 class="text-[4.58015267175572vw] md:text-[2.60416666666667vw] lg:text-[2.34375vw] leading-[5.34351145038168vw] md:leading-[3.125vw] lg:leading-[2.734375vw] text-[#1E1E1E] font-normal text-center font-gilda mt-[7.63358778625954vw] md:mt-[3.38541666666667vw] lg:mt-[2.109375vw]"><?php echo get_field('services_title');?></h3>
    </div>
    </section>

    <section class="mt-[16.2849872773537vw] md:mt-[10.8072916666667vw] lg:mt-[8.28125vw]">
    <div class="w-[83.4605597964377vw] mx-auto md:hidden">
    ...
    <div class="w-[83.4605597964377vw] md:w-[88.1510416666667vw] lg:w-[83.828125vw] flex-wrap justify-between mx-auto hidden md:flex">
        <div class="w-[83.4605597964377vw] md:w-[27.4vw] lg:w-[23.4375vw]">
...
<section class="mt-[18.0661577608142vw] md:mt-[10.546875vw] lg:mt-[8.125vw]">
    ...
    <div class="bg-[#1E1E1E] w-full py-[15.2671755725191vw] md:py-[10.546875vw] lg:py-[9.6875vw]">
        <div class="w-[83.4605597964377vw] md:w-[85.4166666666667vw] lg:w-[73.359375vw] mx-auto flex flex-wrap justify-between items-center">
            ...
            <div class="w-[81.4249363867684vw] md:w-[46.7447916666667vw] lg:w-[37.96875vw] order-1 md:order-2 grid gap-[6.87022900763359vw] md:gap-[3.515625vw] lg:gap-[2.96875vw]">
                ...
                <h3 class="text-[4.58015267175572vw] md:text-[2.60416666666667vw] lg:text-[2.34375vw] leading-[5.34351145038168vw] md:leading-[3.125vw] lg:leading-[2.734375vw] text-white font-gilda font-normal text-center md:text-left"><?php echo get_field('about_title');?></h3>
                <hr class="border-[0.25px] border-[#fff] w-[83.4605597964377vw] md:w-[39.0625vw] lg:w-[23.4375vw] hidden md:block">
                <p class="w-[71.2468193384224vw] md:w-[47.1354166666667vw] lg:w-[38.1vw] text-[2.54452926208651vw] md:text-[1.30208333333333vw] lg:text-[0.9375vw] leading-[3.56234096692112vw] md:leading-[1.82291666666667vw] lg:leading-[1.40625vw] text-white font-light hidden md:block"><?php echo get_field('about_text');?></p>
                <hr class="border-[0.25px] border-[#fff] w-[83.4605597964377vw] md:w-[39.0625vw] lg:w-[23.4375vw] hidden md:block">
            </div>
...
<!-- FOOTER HOME -->
    ...
    <div class="w-[81.4249363867684vw] md:w-[66.015625vw] lg:w-[57.03125vw] mx-auto">
        ...
        <h3 class="text-[4.58015267175572vw] md:text-[2.60416666666667vw] lg:text-[2.34375vw] leading-[5.34351145038168vw] md:leading-[3.125vw] lg:leading-[2.734375vw] text-[#1E1E1E] font-normal text-center font-gilda mt-[7.63358778625954vw] md:mt-[3.38541666666667vw] lg:mt-[2.109375vw]"><?php echo get_field('contact_title');?></h3>
    </div>
