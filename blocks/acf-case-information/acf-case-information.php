 ...
 <section class="element-fade-in mt-[9.66921119592875vw] md:mt-[4.94791666666667vw] lg:mt-[3.90625vw]">
    <div class="w-[73.2824427480916vw] md:w-[87.5vw] lg:w-[82.96875vw] mx-auto flex flex-wrap justify-between">
        <div class="w-[73.2824427480916vw] md:w-[56.9010416666667vw] lg:w-[53.828125vw]">
            <h3 class="text-[2.54452926208651vw] md:text-[1.30208333333333vw] lg:text-[0.78125vw] leading-[3.56234096692112vw] md:leading-[1.82291666666667vw] lg:leading-[1.09375vw] font-medium text-[#1E1E1E] uppercase tracking-wider">Client</h3>
            ...
            <h3 class="text-[2.54452926208651vw] md:text-[1.30208333333333vw] lg:text-[0.78125vw] leading-[3.56234096692112vw] md:leading-[1.82291666666667vw] lg:leading-[1.09375vw] font-medium text-[#1E1E1E] uppercase mt-[7.63358778625954vw] md:mt-[3.25520833333333vw] lg:mt-[2.34375vw] tracking-wider">Project</h3>
        ...
        <div class="delayed-animation w-[73.2824427480916vw] md:w-[26.0416666666667vw] lg:w-[23.4375vw] text-left md:text-right">
            ...
            <h3 class="text-[2.54452926208651vw] md:text-[1.30208333333333vw] lg:text-[0.78125vw] leading-[3.56234096692112vw] md:leading-[1.82291666666667vw] lg:leading-[1.09375vw] font-medium text-[#1E1E1E] uppercase mt-[7.63358778625954vw] md:mt-[unset] tracking-wider">Project scope</h3>
            <?php
            if( have_rows('scope') ):
    ...
    <div class="w-[83.4605597964377vw] md:w-[87.5vw] lg:w-[82.96875vw] mx-auto">
            ...
            <div class="accordion-group">
                <div class="block-fade-in accordion-item">
                    <button class="accordion text-left">
                        <span class="text-[2.54452926208651vw] md:text-[1.82291666666667vw] lg:text-[1.71875vw] leading-[4.58015267175572vw] md:leading-[2.34375vw] lg:leading-[2.03125vw] font-normal text-[#1E1E1E] uppercase my-[5.85241730279898vw] tracking-wider">The challange</span>
                    </button>
                    <div class="panel">
                ...
                <div class="block-fade-in accordion-item">
                    <button class="accordion text-left">
                        <span class="text-[2.54452926208651vw] md:text-[1.82291666666667vw] lg:text-[1.71875vw] leading-[4.58015267175572vw] md:leading-[2.34375vw] lg:leading-[2.03125vw] font-normal text-[#1E1E1E] uppercase my-[5.85241730279898vw] tracking-wider">The approach</span>
                    </button>
                    <div class="panel">
                        <div class="border-[#000] borer-t-[0.5px]"></div>
                        <div class="my-[6.87022900763359vw]">
                ...
                <div class="block-fade-in accordion-item">
                    <button class="accordion text-left">
                        <span class="text-[2.54452926208651vw] md:text-[1.82291666666667vw] lg:text-[1.71875vw] leading-[4.58015267175572vw] md:leading-[2.34375vw] lg:leading-[2.03125vw] font-normal text-[#1E1E1E] uppercase my-[5.85241730279898vw] tracking-wider">The outcome</span>
                    </button>
                    <div class="panel">
                        <div class="border-[#000] borer-t-[0.5px]"></div>
                        <div class="my-[6.87022900763359vw]">
        ...
        <div class="element-fade-in flex-wrap justify-between hidden md:flex">
            <div class="block-fade-in w-[83.4605597964377vw] md:w-[26.0416666666667vw] lg:w-[23.4375vw]">
                <h3 class="text-[2.54452926208651vw] md:text-[1.30208333333333vw] lg:text-[0.78125vw] leading-[3.56234096692112vw] md:leading-[1.82291666666667vw] lg:leading-[1.09375vw] font-medium text-[#1E1E1E] uppercase tracking-wider">The challange</h3>
            ...
            <div class="block-fade-in w-[83.4605597964377vw] md:w-[26.0416666666667vw] lg:w-[23.4375vw]">
                <h3 class="text-[2.54452926208651vw] md:text-[1.30208333333333vw] lg:text-[0.78125vw] leading-[3.56234096692112vw] md:leading-[1.82291666666667vw] lg:leading-[1.09375vw] font-medium text-[#1E1E1E] uppercase tracking-wider">The approach</h3>
                <div class="border-[#000] border-t-[0.5px] md:my-[2.47395833333333vw] lg:my-[1.484375vw]"></div>
            ...
            <div class="block-fade-in w-[83.4605597964377vw] md:w-[26.0416666666667vw] lg:w-[23.4375vw]">
                <h3 class="text-[2.54452926208651vw] md:text-[1.30208333333333vw] lg:text-[0.78125vw] leading-[3.56234096692112vw] md:leading-[1.82291666666667vw] lg:leading-[1.09375vw] font-medium text-[#1E1E1E] uppercase tracking-wider">The outcome</h3>
                <div class="border-[#000] border-t-[0.5px] md:my-[2.47395833333333vw] lg:my-[1.484375vw]"></div>
