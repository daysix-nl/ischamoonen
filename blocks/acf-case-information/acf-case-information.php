...
<div class="bg-[#FFFCF3] case">
 ...
 <section class="mt-[9.66921119592875vw] md:mt-[4.94791666666667vw] lg:mt-[3.90625vw]">
    <div class="w-[73.2824427480916vw] md:w-[87.5vw] lg:w-[82.96875vw] mx-auto flex flex-wrap justify-between">
        <div class="w-[73.2824427480916vw] md:w-[56.9010416666667vw] lg:w-[53.828125vw]">
            ...
            <h1 class="text-[4.58015267175572vw] md:text-[2.60416666666667vw] lg:text-[2.34375vw] leading-[5.34351145038168vw] md:leading-[3.125vw] lg:leading-[2.734375vw] font-gilda font-normal text-[#1E1E1E] mt-[1.01781170483461vw] md:mt-[0.520833333333333vw] lg:mt-[0.3125vw]"><?php echo get_field('client');?></h1>
            ...
            <h2 class="text-[4.58015267175572vw] md:text-[2.60416666666667vw] lg:text-[2.34375vw] leading-[5.34351145038168vw] md:leading-[3.125vw] lg:leading-[2.734375vw] font-gilda font-normal text-[#1E1E1E] mt-[1.01781170483461vw] md:mt-[0.520833333333333vw] lg:mt-[0.3125vw]"><?php echo get_field('project');?></h2>
        </div>
        <div class="w-[73.2824427480916vw] md:w-[26.0416666666667vw] lg:w-[23.4375vw] text-left md:text-right">
